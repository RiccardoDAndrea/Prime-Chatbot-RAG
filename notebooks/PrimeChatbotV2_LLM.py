...
class PrimeChatbot:
    ...
    def create_chroma(self):
        embeddings = self.create_vectorstore()
...
print(vectorstore)
question = "Can you name a few authors that were mentioned in references in the paper Two Hundred Years of Cancer Research"
